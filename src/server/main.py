...
# 全局常量，避免重複創建
NAV_ITEMS = [
    {"title": "Upload", "value": "upload", "href": "/tab/upload"},
    {"title": "Events", "value": "events", "href": "/tab/events"},
    {"title": "Breeds", "value": "breeds", "href": "/tab/breeds"},
    {"title": "Sales", "value": "sales", "href": "/tab/sales"},
    {"title": "Feeds", "value": "feeds", "href": "/tab/feeds"},
    {"title": "Farm Production", "value": "farm_production", "href": "/tab/farm_production"},
    {"title": "SQL", "value": "sql", "href": "/tab/sql"},
]
...
async def index(request: Request, tab: str = "upload"):
    ...
    return templates.TemplateResponse(
        "index.html", {"request": request, "tab": tab, "nav_items": NAV_ITEMS, "active_tab": tab}
    )
...
async def get_tab(request: Request, tab: str):
    ...
    # 直接返回標籤頁內容，使用 CSS 來處理 active 狀態
