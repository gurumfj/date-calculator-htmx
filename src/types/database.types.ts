    ...
    Tables: {
      ...
      farm_production: {
        Row: {
          ...
          batch_name: string;
          catch_fee: number | null;
          chick_cost: number | null;
          cost_price: number | null;
          created_at: string | null;
          expenses: number | null;
          farm_med_cost: number | null;
          fcr: number | null;
          feed_cost: number | null;
          feed_med_cost: number | null;
          feed_weight: number | null;
          gas_cost: number | null;
          grow_fee: number | null;
          id: number;
          leg_band_cost: number | null;
          meat_cost: number | null;
          revenue: number | null;
          sale_weight_jin: number | null;
          updated_at: string | null;
          vet_cost: number | null;
          weigh_fee: number | null;
        };
        Insert: {
          avg_price?: number | null;
          batch_name: string;
